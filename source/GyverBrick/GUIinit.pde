void GUIinit() {
  ...
  cp5.addToggle("grayscale").setCaptionLabel("Ч/Б").setPosition(10, 160).setSize(45, 25).setMode(ControlP5.SWITCH).setValue(true);

  cp5.addToggle("numbers").setCaptionLabel("ЦИФРЫ").setPosition(65, 160).setSize(45, 25).setMode(ControlP5.SWITCH).setValue(true);

  cp5.addSlider("p_value").setCaptionLabel("ЦВЕТОВ").setPosition(120, 160).setSize(100, 25).setRange(2, 10).setValue(4).setNumberOfTickMarks(9);
  cp5.getController("p_value").getCaptionLabel().setPaddingX(-55);

  cp5.addSlider("result_width").setCaptionLabel("ШИРИНА").setPosition(10, 220).setSize(210, 25).setRange(1, 32*4).setValue(64).setNumberOfTickMarks(32*4-1).showTickMarks(false);
  cp5.getController("result_width").getCaptionLabel().setPaddingX(-60);

  cp5.addSlider("result_height").setCaptionLabel("ВЫСОТА").setPosition(10, 250).setSize(210, 25).setRange(1, 32*4).setValue(64).setNumberOfTickMarks(32*4-1).showTickMarks(false);
  cp5.getController("result_height").getCaptionLabel().setPaddingX(-60);
  
  cp5.addSlider("result_bright").setCaptionLabel("ЯРКОСТЬ").setPosition(10, 280).setSize(210, 25).setRange(1, 200).setValue(100);
